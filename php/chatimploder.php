...
$Get_Messages="select * from ".$_SESSION["CTN"]." where sender is not null";
$messages= array();
$datetime= array();
		...
		if ($message_display[$m]==$_SESSION["id_store"]) 
{
	...
	echo "<div class='mdv'><span class='r'>".$message_display[$m+1]."</span><br style='font-size:30px;'><span class='rt'>".$datetime[$j]."</span><br></div>";}$m++;
		$j++;
